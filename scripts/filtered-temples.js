document.addEventListener("DOMContentLoaded", () => {
  ...
  const temples = [
      ...
      },
      {
          ...
          area: 19184,
          imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/johannesburg-south-africa-temple/johannesburg-south-africa-temple-22467-thumb.jpg"
      }
  ];
  ...
  function createTempleCard(temple) {
      ...
      caption.innerHTML = `
          ...
          <p><strong>Area:</strong> ${Number(temple.area).toLocaleString()} sq ft</p>
      `;
